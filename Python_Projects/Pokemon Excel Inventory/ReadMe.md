...
- [x] Create a menu that lets you pick what the program will do
- [ ] Setup functionality so each menu item exports to excel
- [ ] Make as many functions re-usable as possible  

## Current Version(s)
0.1: MVP I guess program runs and outputs the Berries currently loaded into the API all 64 with their names, noticed there's like 3-4 berries that aren't metallic? That the API ignores will fix that later
